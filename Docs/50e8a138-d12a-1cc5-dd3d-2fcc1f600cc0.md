...
**Dehumidifiers** as listed on NRCans searchable database: [https://spl-lpi.nrcan-rncan.gc.ca/en-US/product/?product=Dehumidifiers.Portable](https://spl-lpi.nrcan-rncan.gc.ca/en-US/product/?product=Dehumidifiers.Portable)
...
|---|---|---|
| **Portable dehumidifier** | **25.00 or less** | **1.30** |
| | **25.01-50.00** | **1.60** |
| | **50.01 or more** | **2.80** |
| **Whole-home dehumidifier** | **Case volume (cubic feet)** | **Minimum integrated energy factor (litres/kWh)** |
| | **8.0 or less** | **1.77** |
| | **More than 8.0** | **2.41** |
