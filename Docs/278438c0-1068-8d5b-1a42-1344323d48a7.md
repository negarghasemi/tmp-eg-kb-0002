...
- **[Types of Air Conditioners](#types)**
- **[Coming to Terms with Air Conditioners](#terms)**
- **[Energy Efficiency Regulations  Labelling, Ratings and Certification](#regulations)**
- **[Room Air Conditioners](#room)**
- **[Central Air Conditioners](#central)**
- **[Air-Conditioning Operating Costs](#costs)**
- **[Answers to Some Commonly Asked Questions](#answers)**
...
In bungalows with unfinished basements, the addition off a duct system may be relatively simple and inexpensive, but in other cases, this option is usually expensive and frequently impractical. In these cases, there are two other options for central systems:
...
- **Refrigerant**: A substance that circulates through the air conditioner, alternately absorbing, transporting and releasing heat.
- **Coil**: A system of tubing loops through which refrigerant flows and where heat transfer takes place. The tubing may have fins to increase the surface area available for heat exchange.
- **Evaporator**: A coil that allows the refrigerant to absorb heat from its surroundings, causing the refrigerant to boil and become a low-temperature vapour.
- **Compressor**: Squeezes the molecules of the refrigerant gas together, increasing the pressure and temperature of the refrigerant.
- **Condenser**: A coil that allows the refrigerant gas to give off heat to its surroundings and become a liquid.
- **Expansion device**: Releases the pressure created by the compressor. This causes the temperature to drop and the refrigerant to become a low-temperature vapour/liquid mixture.
- **Plenum**: An air compartment that forms part of the system for distributing warmed or cooled air through the house. It is generally a large compartment immediately above the heat exchanger.

### Other terms

- **Btu/h** (_British thermal unit per hour_): A measure of the heat output of a heating system. One Btu is the amount of heat energy given off by a typical birthday candle. If this heat energy were released over the course of one hour, it would be the equivalent of 1 Btu/h.
- **kW** (_kilowatt_): Is equal to 1000 watts. This is the amount of power required by ten 100-watt light bulbs.
- **Ton**: A measure of cooling capacity. It is equivalent to 3.5 _kilowatt_ or 12 000 Btu/h.
- **Capacity of an air conditioner**: A measure of the maximum rate at which it can remove heat from the conditioned space. Capacity is expressed in British thermal units per hour or tons and is determined under a specific set of test conditions.
- **Cooling load**: Also stated in Btu/h, is the maximum amount of heat that builds up in a space without a cooling system operating. It is calculated to determine the capacity of air conditioner required.
- **Heat gain**: A term applied to various components of the heat load, such as appliance heat gain and solar heat gain. All of the heat gain components are summed to calculate the cooling load.
- **Oversizing**: The practice of selecting an air conditioner with a cooling capacity greater than the cooling load.
- **Undersizing**: The practice of selecting an air conditioner with a cooling capacity smaller than the cooling load.
- **Energy efficiency ratio (EER)**: A measure of how much cooling effect is provided by the air conditioner for each unit of electrical energy that it consumes under steady-state operation. It is determined by dividing the cooling output of the unit, in British thermal units per hour, by the electrical power input, in watts, at a specific temperature. The higher the _energy efficiency ratio_, the more efficient the unit.
- **Seasonal energy efficiency ratio (SEER)**: A measurement of the cooling efficiency of the air conditioner over the entire cooling season. It is determined by dividing the total cooling provided over the cooling season, in British thermal units per hour, by the total energy used by the air conditioner during that time, in watt/hours. The _seasonal energy efficiency ratio_ is based on a climate with an average summer temperature of 28C.
- **Bel (B)**: Is a unit of sound measurement equivalent to 10 dB (decibels). One bel is the threshold of human audibility. The sound level in a busy typing and accounting office would be approximately 6.5 B.
...
The room air conditioner _energy efficiency ratio_ and cooling capacity are determined in accordance with the Canadian Standards Association (CSA) Standard C368.1-M90, which specifies methods of testing, test conditions and tolerances.
...
The efficiency of room air conditioners in converting electricity into cooling effect varies widely, depending on the manufacturer's design choices. Models for window mounting are available with _energy efficiency ratio_ ratings between **12.0 and 8.0**, and units intended for through-the-wall applications have _energy efficiency ratio_s between **9.5 and 8.0**. An ENERGY STAR qualified window-mounted room air conditioner with a cooling capacity under 20 000 Btu/h must have an _energy efficiency ratio_ rating of at least **10.7**.
...
While higher efficiency units are more expensive to manufacture, retail prices do not necessarily reflect this premium. Select a unit with as high an _energy efficiency ratio_ as is practical, to minimize operating costs.
...
The cost of operating a room air conditioner may be minimized by selecting a unit with a high _energy efficiency ratio_ and taking the simple steps listed below:
...
The cost of operating a room air conditioner will depend on the cost of electricity in your area, the cooling capacity, the _energy efficiency ratio_ of the unit and, most importantly, the amount of time that it operates. The weather and the factors highlighted in the \"Operation considerations\" section will significantly influence the number of hours that it runs each year.

_Natural Resources Canada_'s EnerGuide Room Air Conditioner Directory includes conversion tables that provide the approximate energy consumption, in kilowatt hours, of different room air conditioners for different locations across Canada. You can use these tables to estimate the operating cost for your location, air conditioner capacity and _energy efficiency ratio_ rating.
...
Select a central air conditioner with as high a _seasonal energy efficiency ratio_ as is practical within your budget. The annual cooling efficiency of a central air conditioner is affected by the manufacturer's choice of features and components. The _seasonal energy efficiency ratio_ of central air conditioners ranges from a minimum of **10.0** to a maximum of about **17.0**.

An ENERGY STAR qualified central air conditioner must have a _seasonal energy efficiency ratio_ rating of at least **12 or greater** for a single-package unit and **13.0 or greater** for a split system.
...
Advanced reciprocating, scroll and variable-speed or two-speed compressors, when combined with the current best heat exchangers and controls, permit _seasonal energy efficiency ratio_s as high as 17.0. Central air conditioners with the highest _seasonal energy efficiency ratio_s always use variable-speed or two-speed high-efficiency compressors.
...
If your existing air conditioner needs replacement or is more than **10 years old**, chances are good that it is also inefficient. A 10-year-old air conditioner probably has a _seasonal energy efficiency ratio_ rating between **7.0 and 8.0**, compared with some new models that are twice as efficient. The more efficient unit should pay for itself through decreased utility bills and offer improved reliability and warranty protection.

If you have an electric or oil furnace or a conventional gas furnace and your space heating costs **$1,000 or more per year**, you should consider installing an efficient air-source or ground-source heat pump instead of a central air conditioner. Find out from two or three contractors how much more it would cost to add a heat pump to your furnace. Heat pump equipment _seasonal energy efficiency ratio_ ratings are competitive with those of central air conditioners, but heat pumps have the added advantage of providing savings in heating costs during the winter.
...
For more information about heat pumps, read the companion _Natural Resources Canada_ booklet *Heating and Cooling with a Heat Pump*.
...
- efficiency rating of the air conditioner (_seasonal energy efficiency ratio_ or _energy efficiency ratio_)
...
The annual cost of operation of an air conditioner can be calculated as shown below. The method can also be used to provide an estimate of the energy-cost savings of using a more efficient (i.e. higher _seasonal energy efficiency ratio_ or _energy efficiency ratio_ rating) air conditioner.

**Formula for calculating the yearly operating cost of central air conditioners:**

`Cost of operation = (24 x DDc18 / T_OD - 18) x (CAP (35C) / SEER) x (Cost/kW/1000)`

**Formula for calculating the yearly operating cost of room air conditioners:**

`Cost of operation = (24 x DDc18 / T_OD - 18) x (CAP (35C) / 0.9 EER) x (Cost/kW/1000)`

where,

- **DDc18**: number of cooling degree-days (base 18C)
- **T_OD**: summer outdoor design temperature (C) for location
- **CAP (35C)**: the capacity of the air conditioner (in Btu/h) at an entering air temperature of 35C
- **SEER** (_seasonal energy efficiency ratio_): the rated seasonal energy efficiency ratio (Btu/h/W)
- **EER** (_energy efficiency ratio_): the rated energy efficiency ratio
- **Cost per kWh**: local electricity cost (in $/_kilowatt_h)
...
A Toronto resident is considering purchasing a central air conditioner. The utility rate for electricity is **$0.0826/_kilowatt_h**. Toronto has **347 cooling degree-days** and a summer outdoor design temperature of **31C**. The rated capacity of the unit is **36 000 Btu/h** with a rated _seasonal energy efficiency ratio_ of **10.0**.
...
The resident is also considering another unit with identical capacity but with a _seasonal energy efficiency ratio_ of **12.0**. This unit sells for **$250 more**. To compare the two units, perform the same calculation, substituting 12.0 for the _seasonal energy efficiency ratio_.
...
- The contractor should be willing to provide you with information on the unit and its _seasonal energy efficiency ratio_ rating, operation and warranty, and to offer a service contract on the installation. The contractor should be prepared to guarantee the installation work.
...
Yes, under most circumstances. The indoor and outdoor components of central air conditioners are intended to operate together, and the rated _seasonal energy efficiency ratio_ is based on tests of these components working together. Matching a new high-_seasonal energy efficiency ratio_ condensing unit with an old indoor coil would result in an unknown _seasonal energy efficiency ratio_ and probably suboptimum efficiency.
...
Fans require a significant amount of electrical energy to operate. For indoor fans, this energy ends up in the form of heat inside the house, thus adding to the cooling requirement that the air conditioner must meet. So in addition to paying to operate the fan, you will have to pay to remove its heat. The _seasonal energy efficiency ratio_ rating for your system was determined assuming \"auto\" fan operation. Continuous fan operation also reduces dehumidification. For these reasons, fan operation should be restricted to those times when it is providing some tangible benefit.
...
Both central air conditioners and room air conditioners utilize hydrochlorofluorocarbon (_hydrochlorofluorocarbon_-22) as a refrigerant. _hydrochlorofluorocarbon_-22 is not as damaging to the ozone layer as _chlorofluorocarbon_s. _hydrochlorofluorocarbon_-22 does have some ozone-depletion potential, but it is only 5 percent of that of _chlorofluorocarbon_s, since the molecule breaks down fairly rapidly if released into the lower atmosphere.

In some provinces and territories, it is illegal to release _hydrochlorofluorocarbon_s into the atmosphere; soon, this will be the case nationally. Only deal with service companies that practise refrigerant recovery and recycling and have the proper equipment and training to do so. Your air conditioner is designed to operate as a closed system and will not release refrigerant as long as it is properly maintained. Have your system checked for leaks and serviced once a year, before the cooling season.
