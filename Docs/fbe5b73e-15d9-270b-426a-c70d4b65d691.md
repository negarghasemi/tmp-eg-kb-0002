...
- When choosing between similar models, take a close look at the **EnerGuide label** to learn how much energy theyll use each year and over the lifetime of the product. *The lower the number the better!*
- Refrigerators that have earned the **ENERGY STAR Most Efficient** designation are the best of the best  theyll save you more energy than standard models.
