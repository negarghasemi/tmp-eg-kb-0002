...
*   The voluntary EnerGuide label on manufacturer's product literature displays the model's **FE as a percentage**.
*   Use this value to compare fireplaces; models currently on the market have **FEs ranging between 30 and 70 percent**.
...
*   **Note**: Both labels show the statement \"Based on **CSA P.4.1-02**.\" This demonstrates that the FE rating is based on the testing method all gas fireplaces sold in Canada must adhere to.

### EnerGuide label for a single model

*   *Caption*: **EnerGuide label for gas fireplaces for a single model**
...
*   *Caption*: **EnerGuide label for gas fireplaces for a multiple models**
