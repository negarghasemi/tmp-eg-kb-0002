...
-   In the case of a wall-mounted thermostat or a two-component thermostat, it is manufactured on or after **July 1, 2026**.
-   In the case of a built-in thermostat, it is manufactured on or after **July 1, 2027**.

### Compliant product models

[Line voltage thermostats](https://spl-lpi.nrcan-rncan.gc.ca/en-US) as listed on NRCans searchable database.
