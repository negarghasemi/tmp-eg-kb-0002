...
*   **Make the simple choice: look for the ENERGY STAR symbol**
    ...
    *An image with the text \"Energy Star logo\" is displayed.*
...
Being connected allows us to have more insight into our energy use as well as the power to control our home systems remotely. However, being connected does come at an energy cost. **Network-enabled devices can draw as much power in their standby mode as when fully activated**.
