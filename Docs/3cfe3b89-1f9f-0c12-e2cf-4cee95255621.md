# Video Products Energy Efficiency Regulations

## Regulatory Definition

**Video product** is defined as a household electronic product that is encased in a single housing, requires a power supply device in order to operate and is designed:
