...
Start your research [using the ENERGY STAR Product Finder tool to find and compare](https://www.energystar.gov/productfinder/product/certified-water-heaters/results?SetLanguage=English&NRCAN=on) certified water heaters (_NOTE: you will be redirected to the US ENERGY STAR website. Make sure to click Solar with Electric Backup or Solar with Gas Backup under Type when searching._)
...
-   Learn more in our booklet _[Water Heater Guide](/sites/nrcan/files/oee/files/pdf/equipment/WaterHeaterGuide_e.pdf)_.
...
### Collectors
-   **Evacuated tube collectors** are the most efficient collectors available. They can work well in temperatures as low as -40C (-40F) and in overcast conditions. Each tube works like a thermos. Individual tubes can be replaced as needed. These collectors can cost twice as much per square foot as flat plate collectors.
