...
[Ground-source heat pumps](https://spl-lpi.nrcan-rncan.gc.ca/en-US/product/?product=HP.GroundSource) as listed on NRCans searchable database
...
| :--------------------- | :----------------- |
| Open systems  no greater than 40 kW with 15C entering water | 4.75 COPc |
| Closed loop  no greater than 40 kW with 25C entering water | 3.93 COPc |
| **Product type - Heating** | **Minimum efficiency** |
| Open systems  no greater than 40 kW with 10C entering water | 3.6 COPh |
| Closed loop  no greater than 40 kW with 0C entering water | 3.1 COPh |
